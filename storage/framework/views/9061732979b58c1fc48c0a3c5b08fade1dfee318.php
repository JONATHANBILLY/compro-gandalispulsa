	...
	<div class="content-body">
			...
			<h2 class="mb-4">Login Page</h2>
				...
				<form action="<?php echo e(url('/login')); ?>" method="POST" class="my-form">
					...
					<p class="mt-3">Belum memiliki akun? <a href="<?php echo e(url('/register')); ?>" class="text-decoration-none text-primary" style="color: white">Daftar sekarang!</a></p>
				</form>
			</div>
		</div>
...
<?php echo $__env->make('template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\compro-gandalispulsa\resources\views/template/login.blade.php ENDPATH**/ ?>