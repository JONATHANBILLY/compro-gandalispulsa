...
<div class="content" style="background-color: antiquewhite;">
    <?php if(Auth::check()): ?>
        ...
        <?php else: ?>
            <nav class="navbar navbar-expand-lg d-flex py-3 fixed-top shadow" style="background-color: rgba(101,0,13,0.58);">
                <div class="container-fluid">
    ...
    <?php else: ?>
        ...
        <nav class="navbar navbar-expand-lg d-flex fixed-top shadow py-3" style="background-color: rgba(101,0,13,0.58)">
            <div class="container-fluid">
                <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
...
<div id="footer-payment" class="col-md-12 col-sm-12  pt-3 pb-3" style="background-color: rgba(111,64,71,0.77)">
    <div class="container">
        <div class="row">
...
</html><?php /**PATH D:\compro-youwillcelullershop\resources\views/template/template.blade.php ENDPATH**/ ?>