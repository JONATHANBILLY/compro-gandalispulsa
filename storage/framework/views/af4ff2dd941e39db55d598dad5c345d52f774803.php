...
<div class="content">
    ...
    <?php else: ?>
        ...
        <nav class="navbar navbar-expand-lg d-flex fixed-top shadow py-3">
            <div class="container-fluid">
                <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
...
<div id="footer-payment" class="col-md-12 col-sm-12  pt-3 pb-3" style="background-color: gray;">
    <div class="container">
        <div class="row">
...
</html><?php /**PATH D:\compro-new-vortexclawstore\resources\views/template/template.blade.php ENDPATH**/ ?>