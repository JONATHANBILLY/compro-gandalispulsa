...
class SettingWebController extends Controller
{
    ...
    public function saveSettingWeb(Request $request)
    {
        ...
        DB::table('setting_webs')->where('id',1)->update([
           ...
           'kbrstore_api' => $request->kbrstore_api,
           'created_at' => now(),
           'updated_at' => now()
    ...
    public function saveSettingBank(Request $request)
    {
    ...
    public function saveSettingCronos(Request $request)
    {
        
        DB::table('setting_webs')->where('id',1)->update([
          'cronos_key' => $request->cronos_key,
          'cronos_token' => $request->cronos_token
        ]);
     ...
     public function saveSettingMutasi(Request $request)
    {
        ...
        DB::table('setting_webs')->where('id',1)->update([
          ...
          'bri_admin' => $request->bri_admin,
          'bni_admin' => $request->bni_admin,
          'mandiri_admin' => $request->mandiri_admin
