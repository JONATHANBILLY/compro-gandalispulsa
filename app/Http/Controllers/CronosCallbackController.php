...
class CronosCallbackController extends Controller
{
    ...
    public function handle(Request $request)
    {
        ...
        if (JSON_ERROR_NONE !== json_last_error()) {
            return Response::json([
                'success' => false,
                'message' => 'Invalid data sent by Cronos',
            ]);
        }

        $uniqueRef = $data->responseData->id;
        $status = strtoupper((string)$data->responseData->status);
