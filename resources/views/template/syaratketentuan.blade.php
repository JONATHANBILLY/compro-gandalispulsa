        ...
        <div class="container p-3">
            <div class="row justify-content-center">
                <div class="col-lg-8 mx-auto mt-5">
                    <div class="pb-4">
                        <div class="card shadow bg-gradient p-3 kbr-rounded-sedang">
                            <div class="card-header ">
                                <div class="text-dark card-body">
                                    {{--                                {!! !$config ? '' : $config->snk !!}--}}
                                    <h2><strong>Terms and Conditions</strong></h2>
                                    <hr>
                                    <p>Welcome to {{ ENV('APP_NAME') }} GAMAGAME!</p>

                                    <p>These terms and conditions outline the rules and regulations for the use of
                                        {{ ENV('APP_NAME') }}'s Website, located at {{ ENV('APP_URL') }}</p>

                                    <p>By accessing this website we assume you accept these terms and conditions. Do not
                                        continue to use {{ ENV('APP_NAME') }} GAMAGAME if you do not agree to take all of the terms and
                                    ...
                                    <p>The following terminology applies to these Terms and Conditions, Privacy
                                        ...
                                        subject to, prevailing law of id. Any use of the above terminology or other
                                    ...
                                    <p>We employ the use of cookies. By accessing {{ ENV('APP_NAME') }} TOPUP, you agreed to use
                                        cookies in agreement with the {{ ENV('APP_NAME') }}'s Privacy Policy. </p>
                                    ...
                                    <p>Unless otherwise stated, {{ ENV('APP_NAME') }} and/or its licensors own the intellectual
                                        property rights for all material on {{ ENV('APP_NAME') }} TOPUP. All intellectual property
                                        rights are reserved. You may access this from {{ ENV('APP_NAME') }} TOPUP for your own
                                        personal use subjected to restrictions set in these terms and conditions.</p>

                                    <p>You must not:</p>
                                    <ul>
                                        <li>Republish material from {{ ENV('APP_NAME') }} TOPUP</li>
                                        <li>Sell, rent or sub-license material from {{ ENV('APP_NAME') }} TOPUP</li>
                                        <li>Reproduce, duplicate or copy material from {{ ENV('APP_NAME') }} TOPUP</li>
                                        <li>Redistribute content from {{ ENV('APP_NAME') }} TOPUP</li>
                                    </ul>

                                    <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were
                                        created with the help of the <a
                                                href="https://www.termsfeed.com/terms-conditions-generator/">Terms and
                                            Conditions Generator</a>.</p>

                                    <p>Parts of this website offer an opportunity for users to post and exchange
                                        opinions and information in certain areas of the website. {{ ENV('APP_NAME') }} does not
                                        filter, edit, publish or review Comments prior to their presence on the website.
                                        Comments do not reflect the views and opinions of {{ ENV('APP_NAME') }},its agents and/or
                                        affiliates. Comments reflect the views and opinions of the person who post their
                                        views and opinions. To the extent permitted by applicable laws, {{ ENV('APP_NAME') }} shall
                                    ...
                                    <p>{{ ENV('APP_NAME') }} reserves the right to monitor all Comments and to remove any Comments
                                    ...
                                    <ul>
                                        ...
                                        <li>The Comments do not invade any intellectual property right, including
                                    ...
                                    <p>You hereby grant {{ ENV('APP_NAME') }} a non-exclusive license to use, reproduce, edit and
                                    ...
                                    <p>We will approve link requests from these organizations if we decide that: (a) the
                                        ...
                                        of {{ ENV('APP_NAME') }}; and (d) the link is in the context of general resource
                                        information.</p>
                                    ...
                                    <p>If you are one of the organizations listed in paragraph 2 above and are
                                        ...
                                        {{ ENV('APP_NAME') }}. Please include your name, your organization name, contact information
                                    ...
                                    <p>No use of {{ ENV('APP_NAME') }}'s logo or other artwork will be allowed for linking absent a
                                    ...
                                    <p>We reserve the right to request that you remove all links or any particular link
                                        ...
                                        be bound to and follow these linking terms and conditions.</p>
                                    ...
                                    <p>To the maximum extent permitted by applicable law, we exclude all
                                        ...
                                        of this website. Nothing in this disclaimer will:</p>
