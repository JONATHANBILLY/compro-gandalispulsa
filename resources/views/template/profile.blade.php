...
<div class="content-body">
	<div class="col-lg-6 mx-auto px-3 pt-3 mb-3">
		<div class="bg-card p-2 rounded-4">
			<h5 class="text-center my-4">Edit Profile</h5>
			@if ($errors->any())
			...
			@if(session('success'))
				...
				<div class="alert mx-3 alert-success mt-2">
					<ul>
			...
			<form action="{{url('/user/edit/profile')}}" method="POST" class="my-form px-3 mt-3">
				...
				<button class="btn btn-info w-100 my-3 py-2" type="submit" name="tombol" value="submit">Update</button>
			</form>
		</div>
	</div>
</div>
