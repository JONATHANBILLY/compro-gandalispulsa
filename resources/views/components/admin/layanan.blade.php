        ...
        <div class="page-title-box">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item active">Admin Layanan</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('layanan.post') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-5">
                    <input type="number" class="form-control @error('harga_member') is-invalid @enderror" value="{{ old('harga_member') }}" name="harga_member">
                    @error('harga_member')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
