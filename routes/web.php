...
use App\Http\Controllers\CronosCallbackController;
...
Route::get('/getVipReseller', function () {
...
Route::get('/page/terms', [SyaratKetentuanController::class, 'syaratketentuan'])->name('syaratketentuan');
...
Route::post('/callback', [CronosCallbackController::class, 'handle']);
Route::post('/digiflazz-webhook', [DigiflazzWebhookController::class, 'webhookUpdate']);
...
Route::middleware(['auth', 'check.role'])->group(function () {
    ...
    Route::post('/setting/bank', [SettingWebController::class, 'saveSettingBank']);
    Route::post('/setting/cronos', [SettingWebController::class, 'saveSettingCronos']);
